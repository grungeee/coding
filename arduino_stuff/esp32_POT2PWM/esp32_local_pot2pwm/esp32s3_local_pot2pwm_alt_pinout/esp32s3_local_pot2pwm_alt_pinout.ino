/*
  Standalone ESP32-S3 potentiometer to PWM converter.

  Local analog inputs:
    pot1 -> GPIO4
    pot2 -> GPIO5
    pot3 -> GPIO6
    amp meter reserve -> GPIO7
  ...
  Digital outputs:
    switch1 high -> GPIO10, GPIO11 high
    switch2 high -> GPIO12, GPIO13 high
...
const int potPins[3] = {4, 5, 6};
const int ampMeterPin = 7;
const int i2cSdaPin = 8;
const int i2cSclPin = 9;
const int digitalOutPins[6] = {10, 11, 12, 13, 14, 15};
